...
export default class Cart extends Component {
  ...
  handleDelete = clothing => {
    ...
    const filtered = parsedItem.filter(
      otherClothing => otherClothing.id !== clothing.id,
    );
          ...
          <div style={{ paddingTop: '40px', marginLeft: '120px' }}>
            <Table basic="very" celled collapsing>
              ...
              <Table.Body style={{ textAlign: 'center' }}>
                {parsedItem.map(clothing => (
                  <Table.Row key={clothing.id} clothing={clothing}>
                    <Table.Cell>
                    ...
                    <Table.Cell>
                      <h3>
                        <Button
                          onClick={() => this.handleDelete(clothing)}
                          handlename="delete"
                          icon="close"
                        />
                      </h3>
          ...
          <div>
            ...
            >
              <div style={{}}>
                ...
                <Button
                  onClick={() => this.handlePutOrder(totalAmount, parsedItem)}
                  inverted
                  size="big"
                  color="white"
                >
